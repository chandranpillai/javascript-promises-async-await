...
const movies = require("./data/books.json")
...
getBooksAndMoviesAsync(results)
.then (console.log("movies and books", {
    movies: results.movies,
    books: results.books
  }));

  getBooksOrMoviesAsync(results)
  .then (console.log("movies OR books", {
    results
  }));
